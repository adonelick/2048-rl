...
afterStateLearning: afterStateLearning.o game.o state.o ntnn.o
	$(CC) $(CFLAGS) -o afterStateLearning afterStateLearning.o state.o game.o ntnn.o -lpthread

qLearning: qLearning.o game.o state.o ntnn.o
	$(CC) $(CFLAGS) -o qLearning qLearning.o state.o game.o ntnn.o -lpthread
...
afterStateLearning.o: afterStateLearning.cpp state.hpp game.hpp ntnn.hpp
	$(CC) -std=c++11 -c -o afterStateLearning.o afterStateLearning.cpp -lpthread
qLearning.o: qLearning.cpp game.hpp state.hpp ntnn.hpp
	$(CC) -std=c++11 -c -o qLearning.o qLearning.cpp -lpthread
stateLearning.o: stateLearning.cpp game.hpp state.hpp ntnn.hpp
	$(CC) -std=c++11 -c -o stateLearning.o stateLearning.cpp -lpthread
